...
dots_slave = visual.DotStim(win=mywin,
                       nDots=n_dots,
                       element=element_slave,
                       color=(180, saturation, value),
                       colorSpace='hsv',
                       dotSize=dotsize,
                       opacity=opacity,
                       fieldSize=fieldsize,
...
fixation2 = visual.GratingStim(mywin, tex='sin', mask='circle', size=1.0, color=(0, 0, 1), contrast=.5, texRes=256, colorSpace='hsv',sf=0)  # circular grating
fixation3 = visual.GratingStim(mywin, tex='sin', mask='circle', size=1.5, color='white', contrast=-1, sf=0)  # circular grating
